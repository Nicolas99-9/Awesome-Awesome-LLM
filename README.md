...
| Direction  | GitHub Link                                                                                                                                                  | Description                                                | Paper Link | Rec Score |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------- | ---------- | --------- |
| PerceptUI        | [PerceptUI](https://nicolas99-9.github.io/nicolas.bougie.io/perceptui.html) ![](https://img.shields.io/github/stars/Hannibal046/Awesome-LLM.svg)                   | LLM for UI/UX evaluation |            | ★★★★★   
